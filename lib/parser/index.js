...
conditions: {"s":{"rules":[0,1,3,4,7,8,14,15,21,22,30,31,32,33,34],"inclusive":false},"sc":{"rules":[1,2,34],"inclusive":false},"mc":{"rules":[4,5,6,34],"inclusive":false},"ch_start":{"rules":[16],"inclusive":false},"ch":{"rules":[17,18,19,20],"inclusive":false},"im_start":{"rules":[23],"inclusive":false},"im":{"rules":[24,25,26,27,28,29],"inclusive":false},"vari_start":{"rules":[9],"inclusive":false},"vari":{"rules":[10,12,13],"inclusive":false},"vari_colon_start":{"rules":[11],"inclusive":false},"INITIAL":{"rules":[35,36],"inclusive":true}}
});
return lexer;
})();
parser.lexer = lexer;
